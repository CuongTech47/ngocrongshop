...
if(isset($_POST['Submit'])){
	...
	if(strcasecmp($_SESSION['captcha_code'], $_POST['captcha_code']) != 0){  
		$msg="<span style='color:red'>Bạn chưa nhập mã bảo vệ!</span>";// Captcha verification is incorrect.		
	} elseif (empty($_SESSION['captcha_code'] )) {
		$msg="<span style='color:red'>Mã bảo vệ không đúng!</span>";// Captcha verification is incorrect.		
	} else {
