...
$dlc1 = '<div class="alert alert-danger">Bạn chưa nhập tài khoản hoặc mật khẩu</div>';
$dlc2 = '<div class="alert alert-danger">Tài khoản hoặc mật khẩu không chính xác</div>';
$dlc3 = '<div class="alert alert-danger">Bạn đã đăng nhập rồi, vui lòng chờ</div>';
$dlc4 = '<div class="alert alert-success">Đăng nhập thành công, vui lòng chờ</div><script> location.reload(); </script>';
