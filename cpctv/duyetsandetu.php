                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-group date">
        									<select name="service" class="form-control">
                                                ...
                                                <option value="1" <?php if($_GET['service'] == '4') { echo 'selected'; } ?>> Săn Đệ Tử Thuê</option>
                                                <option value="2" <?php if($_GET['service'] == '2') { echo 'selected'; } ?>> Úp Bí Kíp</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
