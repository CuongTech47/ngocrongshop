...
<?php 
$check = mysql_result(mysql_query("SELECT COUNT(*) FROM `Hplayer_ninja` WHERE `id`='$id'"), 0);
$checkk = mysql_result(mysql_query("SELECT COUNT(*) FROM `Hplayer_ninja` WHERE `username` = '".$tom['username']."' AND `id`='$id'"), 0);
if($check < 1){
...
?>
<?php
$getdichvu = array("Không xác định", "Bán xu", "Bán ngọc");
$getserver = array("1", "2", "3", "4", "5", "6", "7");
$TOM_result = mysql_query("SELECT * FROM `Hplayer_ninja` WHERE `username` = '".$tom['username']."' AND id = '$id' LIMIT 1");
...
<?php if ($getdlc[dichvu] == 1) { ?>
                    <p><a href="/dich-vu/ban-xu"><?php echo $getdichvu[$getdlc[dichvu]] ;?></a></p>
<?php } ?>
...
<?php } ?>
                    ...
                    <div class="edu-history-sec" id="education">
                                    ...
                                    <div class="edu-hisinfo">
                                        <h3><?php echo number_format($getdlc[hplayer]) ;?> <?php if($getdlc[dichvu] == 1) { ?>Vàng <?php } else { ?> Ngọc <?php } ?> </h3>
                    ...
                    <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded">
                        <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand">
                            ...
                            <tbody class="m-datatable__body">
                                    ...
                                    <td> Sever</td>
                                    <td>
                                         <?php echo $getserver[$getdlc[server]] ;?> 
