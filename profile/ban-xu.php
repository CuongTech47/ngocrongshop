...
?>
    ...
    <div class="c-content-box c-size-lg c-overflow-hide c-bg-white font-roboto">
        ...
        <div class="text-center" style="margin-bottom: 50px;">
            <h2 style="font-size: 30px;font-weight: bold;text-transform: uppercase">DỊCH VỤ BÁN XU</h2>
            <div class="row  hidden-sm hidden-md hidden-lg">
                <p style="margin-top: 15px;font-size: 23px" class="bb"><i class="fa fa-server" aria-hidden="true"></i> <a href="/dich-vu/ban-vang" style="color:#32c5d2">Ninja School</a></p>
...
if(!$tom['ID']) {
	echo '<div class="alert alert-danger"> Vui lòng đăng nhập để mua xu</div>';
...
} elseif($sotien < 10000 || $sotien >200000 ) {
	echo '<div class="alert alert-danger"> Số tiền bạn nhập phải lớn hơn 10k và nhỏ hơn 200k.</div>';
} elseif($tom['sodu'] < $sotien){
	echo '<div class="alert alert-danger"> Tài khoản của bạn không đủ vui lòng nạp thêm</div>';
} else {
	...
	`tinhtrang` = '0',
	`thoigian` = '".time()."'");
	header('Location: /dich-vu/hplayer-vn');
                ...
                <div class="row-flex-safari service-info">
                    <div class="col-md-5 hidden-xs hidden-sm">
                        <div class="row">
                            <div class="news_image">
                                <img src="https://nick.vn/storage/images/MFcCA9YNbu_1623228714.jpg" alt="Bán Xu">
                            </div>
                        </div>
                        <div class="row">
                            <p style="margin-top: 15px" class="bb"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> Bán Xu</p>
                            <p style="margin-top: 15px" class="bb"><i class="fa fa-server" aria-hidden="true"></i> <a href="/dich-vu/ban-vang" style="color:#32c5d2">Ninja School</a></p>
                    ...
                    <div class="col-md-7">
                                    ...
                                    <select name="server" class="server-filter form-control t14" style="">
                                                                                                                                    <option value="0">Sever 1 - Bokken</option>
                                                    <option value="1">Sever 2,3 - Shuriken + Tessen</option>
                                                    <option value="2">Sever 4 - Kunai</option>  
                                        <option value="3">Sever 5 - Katana  </option>  
                                        <option value="4">Sever 6 - Tone  </option>   
                                        <option value="5">Sever 7 - Sanzu</option>                                                                                                                                                      
                                                                                                                        </select>
                                </div>
                        ...
                        <div class="mb-15">
                            <input name="sotien" autofocus="" value="10000" class="form-control t14  " id="input_pack" type="text" placeholder="Số tiền">
                            <span style="font-size: 14px;">Số tiền thanh toán phải từ <b style="font-weight:bold;">10,000đ</b>  đến <b style="font-weight:bold;">185,000đ</b> </span>
                        </div>
