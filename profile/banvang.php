...
if(!$tom['ID']) {
	echo '<div class="alert alert-danger"> Vui lòng đăng nhập để mua vàng</div>';
...
} elseif($sotien < 10000 || $sotien >185000){
	echo '<div class="alert alert-danger"> Số tiền bạn nhập phải lớn hơn 10k và nhỏ hơn 10tr.</div>';
	...
	$mota = 'Mua '.number_format($sotien).'đ Vàng';
                    ...
                    <div class="col-md-5 hidden-xs hidden-sm">
                        <div class="row">
                            <div class="news_image">
                                <img src="https://nick.vn/storage/images/Q3GWmd3Akw_1623228594.jpg" alt="Bán Vàng">
                            </div>
                        </div>
                        <div class="row">
