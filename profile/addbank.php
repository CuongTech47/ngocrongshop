...
<div class="modal-header">
	...
	<h4 class="modal-title">Thêm tài khoản/nhân vật</h4>
</div>
...
<p id="noticenh"></p>
						...
						<div class="form-group m-t-10">
							...
							<div class="col-md-6">
								<input class="form-control c-square c-theme" type="text" id="account_number" placeholder="Nhập tài khoản..." required="" autofocus="">
							</div>
						</div>
						...
						<div class="form-group m-t-10">
							...
							<div class="col-md-6">
								<input class="form-control c-square c-theme" type="text" id="brand" placeholder="Nhập mật khẩu..." required="">
							</div>
						</div>
...
<p id="noticevi"></p>
					...
					<div class="modal-footer">
						...
						<button onclick="addvi()" id="addvi" class="btn c-theme-btn c-btn-square c-btn-uppercase c-btn-bold">Thêm tên nhân vật</button>
