...
session_start();
$title = 'Danh sách nick win doanh trại';
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-info" role="alert">
                    <h2 class="alert-heading">Nick Win Doanh Trại</h2>
...
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '2' AND ".$to9xvn."  AND ".$dlcht." AND ".$dlcdz.""), 0);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '2' AND ".$to9xvn." AND ".$dlcht." AND ".$dlcdz." ORDER by ID DESC LIMIT $start, $kmess");
} else {
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '2'"), 2);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '2' ORDER by ID DESC LIMIT $start, $kmess");
}
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="classWithPad">
                                ...
                                <div class="description">
                                    ATM - Ví điện tử: <?php echo number_format($getdlc['giatien'] * (100-30)/100)?>đ
                                </div>
