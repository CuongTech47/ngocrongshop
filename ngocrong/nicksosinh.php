...
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '1' AND ".$to9xvn."  AND ".$dlcht." AND ".$dlcdz.""), 0);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '1' AND ".$to9xvn." AND ".$dlcht." AND ".$dlcdz." ORDER by ID DESC LIMIT $start, $kmess");
} else {
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '1'"), 0);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '1' ORDER by ID DESC LIMIT $start, $kmess");
}
