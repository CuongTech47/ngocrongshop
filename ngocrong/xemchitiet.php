            ...
            <div class="row">
                <div class="col-md-4 m-b-20">
                    <div class="c-product-header">
                        <div class="c-content-title-1">
                            ...
                            <span class="c-font-red c-font-bold"><i class="fa fa-tag"></i> <?=$hethong[tenweb];?> - Ngọc rồng</span>
                        </div>
                    </div>
                </div>
					...
					<i class="icon-graph c-rounded c-theme-bg c-font-white"></i>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-6 c-product-variant">
                                <p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold"><i class="fa fa-server"></i> Máy chủ: <span class="c-font-red">Vũ Trụ <?=$gettom['server']?> Sao</span></p>
                            </div>
                            <div class="col-sm-4 col-xs-6 c-product-variant">
                                <p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold"><i class="fa fa-drupal"></i> Hành tinh: <span class="c-font-red"><?=$gethanhtinh[$gettom['hanhtinh']]?></span></p>
                            </div>
                            <div class="col-sm-4 col-xs-6 c-product-variant">
                                <p class="c-product-meta-label c-product-margin-1 c-font-uppercase c-font-bold"><i class="fa fa-list-alt"></i> Đăng ký: <span class="c-font-red">ảo</span></p>
                            </div>
                        </div>
                     <div class="c-content-divider c-icon-bg c-theme-bg">
					<i class="icon-graph c-rounded c-theme-bg c-font-white"></i>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-4 text-right">
                        <div class="c-product-header">
                            <div class="c-content-title-1">
                                <a class="btn btn-lg c-btn-green c-font-uppercase c-font-bold c-btn-circle  m-t-20 btnCheckAccount load-modal" rel="/buyacc/<?=$gettom['ID']?>"><i class="fa fa-cart-arrow-down"></i> Mua ngay</a>
