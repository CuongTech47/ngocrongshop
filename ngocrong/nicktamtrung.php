...
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '0' AND ".$to9xvn."  AND ".$dlcht." AND ".$dlcdz.""), 0);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '0' AND ".$to9xvn." AND ".$dlcht." AND ".$dlcdz." ORDER by ID DESC LIMIT $start, $kmess");
} else {
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '0'"), 0);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '0' ORDER by ID DESC LIMIT $start, $kmess");
}
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="classWithPad">
                                ...
                                <div class="description">
                                    Máy chủ <?php echo $getdlc[server] ;?> - Sao
                                </div>
