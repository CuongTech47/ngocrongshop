...
session_start();
$title = 'Danh sách nick tầm trung';
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-info" role="alert">
                    <h2 class="alert-heading">Ngọc rồng</h2>
...
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '4' AND ".$to9xvn."  AND ".$dlcht." AND ".$dlcdz.""), 0);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '4' AND ".$to9xvn." AND ".$dlcht." AND ".$dlcdz." ORDER by ID DESC LIMIT $start, $kmess");
} else {
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '4'"), 4);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '4' ORDER by ID DESC LIMIT $start, $kmess");
}
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <div class="price_item">
                                                                                                    <?php echo number_format($getdlc[giatien]) ;?>
                                        ...
                                        <div class="col-xs-6 ">
                                            <div class="view">
                                                <a href="/random/<?php echo $getdlc[ID] ;?>">Chi tiết</a>
                                            </div>
                                        </div>
