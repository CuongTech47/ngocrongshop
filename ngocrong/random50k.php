...
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '5' AND ".$to9xvn."  AND ".$dlcht." AND ".$dlcdz.""), 0);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '5' AND ".$to9xvn." AND ".$dlcht." AND ".$dlcdz." ORDER by ID DESC LIMIT $start, $kmess");
} else {
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `TOM_Nick` WHERE `loainick` = '5'"), 5);
$TOM_result = mysql_query("SELECT * FROM `TOM_Nick` WHERE `loainick` = '5' ORDER by ID DESC LIMIT $start, $kmess");
}
