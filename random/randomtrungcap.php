...
session_start();
$title = 'Danh sách nick random trung cấp';
...
<div class="text-center alert alert-success c-font-20" role="alert">
	...
	<div class="c-margin-t-20"></div>
			<div class="row">
<?php
$tong = mysql_result(mysql_query("SELECT COUNT(*) FROM `DLC_Nickrd` WHERE `loainick` = '1'"), 0);
$TOM_result = mysql_query("SELECT * FROM `DLC_Nickrd` WHERE `loainick` = '1' ORDER by ID DESC LIMIT $start, $kmess");
